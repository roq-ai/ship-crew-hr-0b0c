...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'Employee Update.update': { roles: ['owner'], key: 'employee_update', tenantPath: [], userPath: [] },
  'Policy Implementation.create': { roles: ['hr-manager'], key: 'policy_implementation', tenantPath: [], userPath: [] },
};
