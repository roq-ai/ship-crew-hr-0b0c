...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Ship Crew HR`}</title>

        <meta
          name="description"
          content="Ship Crew HR - Navigating Success in Ship Crew Management. Experience streamlined HR processes for optimal crew performance and coordination."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1552207802-77bcb0d13122?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzaGlwfGVufDB8fHx8MTY5NjQ5MDM3Nnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@natecheney?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Nate Cheney`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Ship Crew HR - Navigating Success in Ship Crew Management. Experience streamlined HR processes for optimal crew performance and coordination.`}
            </Text>
            <Box
