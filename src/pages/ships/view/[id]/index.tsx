...
import { getShipById } from 'apiSdk/ships';
import { ShipInterface } from 'interfaces/ship';
import { CrewMemberListPage } from 'pages/crew-members';
import { ScheduleListPage } from 'pages/schedules';

function ShipViewPage() {
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('ship', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/ships/edit/${id}`} passHref legacyBehavior>
                    <Button
