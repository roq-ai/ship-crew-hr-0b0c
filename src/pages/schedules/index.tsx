  ...
  const fetcher = useCallback(
    async () =>
      getSchedules({
        ...
        order: params.order,
        searchTermKeys: ['departure_location.contains', 'arrival_location.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.departure_date ? format(parseISO(record?.departure_date as unknown as string), 'dd-MM-yyyy') : '',
    },
    {
      id: 'arrival_date',
      header: 'Arrival Date',
    ...
    { id: 'arrival_location', header: 'Arrival Location', accessorKey: 'arrival_location' },
