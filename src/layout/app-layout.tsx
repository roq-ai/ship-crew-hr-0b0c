...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Logs', path: '/logs', entity: 'log', service: AccessServiceEnum.PROJECT, icon: FiFileText },
    { name: 'Schedules', path: '/schedules', entity: 'schedule', service: AccessServiceEnum.PROJECT, icon: FiCalendar },
    { name: 'Ships', path: '/ships', entity: 'ship', service: AccessServiceEnum.PROJECT, icon: FiAnchor },
